...
const PAGES = [
  ...
  { id: 'coquitlam',     slug: 'coquitlam',                   title: 'Garage Door Repair Coquitlam — Same-Day Service | POCO',               description: 'Local garage door repair, spring replacement and opener installation in Coquitlam. Same-day response, written warranty, licensed and insured. 778-831-0239.', og: 'images/hero-garage.jpg' },
  { id: 'portcoquitlam', slug: 'port-coquitlam',              title: 'Garage Door Repair Port Coquitlam — POCO Garage Doors',                description: 'Same-day garage door repair in Port Coquitlam: broken springs, cables, openers, off-track doors. Locally owned. Call 778-831-0239 for a free quote.', og: 'images/hero-garage.jpg' },
  { id: 'portmoody',     slug: 'port-moody',                  title: 'Garage Door Repair Port Moody — Same-Day Service | POCO',              description: 'Garage door spring, opener and panel repair in Port Moody (including Anmore & Belcarra). Same-day response, lifetime spring warranty. 778-831-0239.', og: 'images/hero-garage.jpg' },
